/*
This server functions as a proxy to recevie a message from the client, and to forward that message to Logentries.  Only the server knows the log token so it can't be discovered by users or man in the middle attacks.
